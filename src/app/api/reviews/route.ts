...
export async function GET(request: Request) {
  ...
  if (tree_id && user_id) {
    ...
    return NextResponse.json(
      { error: 'Bad request. You may only provide one parameter.' },
      { status: 400 },
    );
...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'An error occurred when creating fruit tree review.' },
      { status: 500 },
    );
  }
}
export async function PATCH(request: Request) {
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'An error occurred when deleting a fruit tree review.' },
      { status: 500 },
    );
  }
}
...
export async function DELETE(request: Request) {
  ...
  if (!data || !data.reviewId) {
    return NextResponse.json(
      { error: 'The request body is missing a required attribute' },
      { status: 400 },
    );
  }

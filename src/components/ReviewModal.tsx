                ...
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                  ...
                  >
                    <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                      ...
                      <div className="sm:flex sm:items-start mt-3">
                        <div className="mt-3 text-center sm:ml-4 sm:mt-0">
                          <Dialog.Title
                            as="h3"
                            className="text-2xl leading-8 sm:text-center font-semibold text-gray-900"
                          >
                            {treeDesc}
                          </Dialog.Title>
                          <div className="mt-2 sm:text-left">
                            ...
                            <div className="py-2">
                              <label htmlFor="reviewText" className="mb-8">
                                Write Your Review:
                              </label>
                              <textarea
                                id="reviewText"
                                placeholder="Leave your thoughts about the fruit here"
                    ...
                    <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                      <input
                        className="mt-3 ml-3 inline-flex w-full justify-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-indigo-500 sm:mt-0 sm:w-auto"
                        type="submit"
                        value="Post"
                      />
                      <button
                      ...
                      <button
                        type="button"
                        onClick={() => setOpen(false)}
                        className="btn btn-xs btn-square btn-ghost absolute right-2 top-2"
                      >
                        ✕
                      </button>
                    </div>
